    ...
    <main>
        ...
        <div class="theForm">
         ...
         are later in the form for clarity -->
            ...
            <form class="open-loan-form" id="mainForm" action="insert.php" method="post" onsubmit="return confirmCheck()">
                ...
                <div class="button open-loan-buttons" style="display: flex; justify-content: space-between;">
                    <!-- calculate repayments button -->
                    <div class="button">
                        <input id="calculate-repayments-button" type="submit" value="Calculate Repayments" form="calcpay" />
                    </div>
                    <!-- submit button -->
                    <div class="button">
                        <input id="open-loan-account-button" type="submit" value="Open Loan Account" />
                    </div>
                </div>
