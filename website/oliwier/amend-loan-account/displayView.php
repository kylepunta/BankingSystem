...
$sql = "SELECT Customer.customerNo, firstName, surName, address, eircode, dateOfBirth, 
        ...
        WHERE Customer.customerNo = ". $_POST['custID'] . " AND `Loan Account`.`accountNumber` = " . $_POST['closeAccountNumber'] . ";";
...
if ($rowcount == 1) {
    ...
    $_SESSION['repayments']=$row['loanMonthlyRepayments'];
    $_SESSION['term']=$row['loanTerm'];
    $_SESSION['amount']=$row['loanAmount'];
