...
<body>
    ...
    WHERE `accountNumber` = '$_POST[accountno]' AND `customerNo` = '$_POST[cid]'";
        ...
        if (mysqli_num_rows($result) != 0) {
            ...
            require($_SERVER["DOCUMENT_ROOT"] . '/darian/currentDepositAccountDetails.inc.php');
        } else {
    ...
    <main>
        <form id="withdrawals-form" action="./" onsubmit="return confirmSubmit()" method="post">
            <!-- the heading of the form -->
            <h1>Withdrawals</h1>
            <!-- smaller text under the main heading -->
            <h4>Select a current or deposit account, enter a withdrawal amount, then click the withdraw button to
                make a withdrawal.</h4>
            ...
            <div class="inputbox">
                ...
                <datalist id="accounts">
                    <?php require($_SERVER["DOCUMENT_ROOT"] . '/darian/currentDepositAccountList.php'); ?>
                </datalist>
            </div>
